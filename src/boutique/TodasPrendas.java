 ...
 * @author Marc
 */
public class TodasPrendas extends javax.swing.JDialog {

    private ArrayList<Prenda> prendas;

    int contador = 0;
    
    public TodasPrendas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
